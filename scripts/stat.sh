origin_path=/home/cyf/dataHDD/linuxVersion
gzip_container_path=/home/cyf/cDedup/TEST/metadata/ContainersGZIP
...
after_compression_size=$(du -sb $gzip_container_path | awk '{print $1}')
